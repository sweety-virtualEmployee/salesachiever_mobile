...
class OpportunityInfoScreen extends StatefulWidget {
  final Map<String, dynamic> deal;
  final bool readonly;
  final Function onSave;
  final Function onBack;

  OpportunityInfoScreen({
    Key? key,
    required this.deal,
  ...
  @override
  _OpportunityInfoScreenState createState() => _OpportunityInfoScreenState();
}

class _OpportunityInfoScreenState extends State<OpportunityInfoScreen> {
  dynamic _deal;
  bool _readonly = true;
  bool _isValid = false;
  String _dealTypeId = '';
