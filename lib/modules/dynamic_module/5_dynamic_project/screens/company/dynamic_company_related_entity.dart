...
class _DynamicCompanyRelatedEntityScreenState
  ...
  callApi() async {
    ...
    if (widget.entity?["ACCT_ID"]!=null) {
      ...
      _dynamicTabProvider.getCompanyEntity["ACCTNAME"] = entity.data["ACCTNAME"];
    }
          ...
          return PsaScaffold(
            action: (widget.type == 'company' ||
              ...
              onTap: () async {
                    ...
                    platformPageRoute(
                      ...
                      builder: (BuildContext context) => AddRelatedEntityScreen(
                        ...
                        contact: provider.getCompanyEntity['CONT_ID'] != null
                          ...
                          'TEXT': '${provider.getCompanyEntity['FIRSTNAME'] ?? ''} ${provider.getCompanyEntity['SURNAME'] ?? ''}',
                        }
                            : {},
                        type: "",
                      ),
                  ...
                  await Navigator.push(
                    ...
                    platformPageRoute(
                      ...
                      builder: (BuildContext context) => AddRelatedEntityScreen(
                        ...
                        contact: {
                          'ID': provider.getCompanyEntity['CONT_ID'],
                          'TEXT': provider.getCompanyEntity['CONT_ID'] !=
                              null
                              ? '${provider.getCompanyEntity['FIRSTNAME'] ??
                              ''} ${provider.getCompanyEntity['SURNAME'] ?? ''}'
                              : null,
                        },
                      ),
                    ),
                ...
                : ((widget.type == 'projects' && provider.getCompanyEntity['CONT_ID'] == null) && (widget.entityType != "ACTION"))
                ? PsaAddButton(
              onTap: () async {
                if (provider.getCompanyEntity['ACCT_ID'] != null) {
                  ...
                  if (provider.getCompanyEntity['DEAL_ID'] != null) {
                    var project = await DynamicProjectService()
                        .getEntityById(
                        "OPPORTUNITY", provider.getCompanyEntity['DEAL_ID']);
                    print(
              ...
              onTap: () async {
                      ...
                      platformPageRoute(
                        ...
                        builder: (BuildContext context) =>
                            DynamicActionTypeScreen(
                              action: {"ACCT_ID": widget.entity?["ACCT_ID"]},
                              popScreens: 2,
                ...
                ? PsaAddButton(
              onTap: () async {
                if (provider.getCompanyEntity['MULTI_ID'] == null &&
                    provider.getCompanyEntity['PROJECT_ID'] != null) {
                  ...
                  print("result${result}");
                  dynamic value = {
                    "PROJECT_ID": provider.getCompanyEntity['PROJECT_ID']
                  };
                  print(value);
                  ...
                  if (provider.getCompanyEntity['ACCT_ID'] != null) {
                    ...
                    await DynamicProjectService()
                        ...
                        provider.getCompanyEntity['ACCT_ID']);
                    print(
                      ...
                      builder: (BuildContext context) =>
                          AddRelatedEntityScreen(
                            ...
                            project: {
                              'ID': provider.getCompanyEntity['PROJECT_ID'],
                              'TEXT':
                              provider.getCompanyEntity['PROJECT_TITLE'],
                            },
                            account: provider.getCompanyEntity['ACCT_ID'] !=
                                null
                                ? {
                              'ID':
                              provider.getCompanyEntity['ACCT_ID'],
                              ...
                              provider.getCompanyEntity['ACCTNAME'],
                                ...
                                : {},
                            contact: provider.getCompanyEntity['CONT_ID'] !=
                                null
                                ? {
                              'ID':
                              provider.getCompanyEntity['CONT_ID'],
                              'TEXT':
            ...
            body: Column(
              children: [
                Container(
                    height: 70,
                    child: CommonHeader(
                        entityType: widget.entityType, entity: provider.getCompanyEntity)),
                Container(
                  color: Colors.white,
                  height: 20,
                ),
  ...
  Future<void> handleOnTapFunction(dynamic item) async {
      ...
      if (widget.type == "opp history") {} else if (widget.type == "quotes") {
