...
class DynamicCompanyInfoScreen extends StatefulWidget {
  ...
  @override
  _DynamicCompanyInfoScreenState createState() => _DynamicCompanyInfoScreenState();
}

class _DynamicCompanyInfoScreenState extends State<DynamicCompanyInfoScreen> {
  dynamic _company;
  bool _readonly = true;
  bool _isValid = false;
