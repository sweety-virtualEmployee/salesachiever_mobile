...
class DynamicContactInfoScreen extends StatefulWidget {
  ...
  @override
  _DynamicContactInfoScreenState createState() => _DynamicContactInfoScreenState();
}

class _DynamicContactInfoScreenState extends State<DynamicContactInfoScreen> {
  dynamic _contact;
  bool _readonly = true;
  bool _isValid = false;
