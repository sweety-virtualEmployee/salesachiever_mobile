...
class DynamicActionInfoScreen extends StatefulWidget {
  ...
  @override
  _DynamicActionInfoScreenState createState() => _DynamicActionInfoScreenState();
}

class _DynamicActionInfoScreenState extends State<DynamicActionInfoScreen> {
  dynamic _action;
  bool _readonly = true;
  bool _isValid = false;
