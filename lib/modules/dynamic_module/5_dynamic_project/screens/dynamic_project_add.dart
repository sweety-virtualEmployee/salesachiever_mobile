...
class DynamicProjectAddScreen extends StatefulWidget {
  final Map<String, dynamic> project;
  final bool readonly;

  const DynamicProjectAddScreen({
    Key? key,
  ...
  @override
  _DynamicProjectAddScreenState createState() => _DynamicProjectAddScreenState();
}

class _DynamicProjectAddScreenState extends State<DynamicProjectAddScreen> {
  bool _readonly = true;
  dynamic _project;
  String _notes = '';
  bool? _isNewNote;
