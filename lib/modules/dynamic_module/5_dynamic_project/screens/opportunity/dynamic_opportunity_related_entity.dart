...
class DynamicOpportunityRelatedEntityScreen extends StatefulWidget {
  const DynamicOpportunityRelatedEntityScreen({
    Key? key,
  ...
  @override
  _DynamicOpportunityRelatedEntityScreenState createState() =>
      _DynamicOpportunityRelatedEntityScreenState();
}

class _DynamicOpportunityRelatedEntityScreenState
    extends State<DynamicOpportunityRelatedEntityScreen> {
  List<dynamic> list = [];
