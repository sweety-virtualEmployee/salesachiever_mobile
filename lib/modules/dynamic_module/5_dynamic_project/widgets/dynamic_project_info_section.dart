...
class DynamicProjectInfoSection extends StatefulWidget {
  const DynamicProjectInfoSection({
    Key? key,
    required project,
  ...
  @override
  _DynamicProjectInfoSectionState createState() => _DynamicProjectInfoSectionState();
}

class _DynamicProjectInfoSectionState extends State<DynamicProjectInfoSection> {
